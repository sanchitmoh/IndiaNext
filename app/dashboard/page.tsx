      ...
      <div className="min-h-screen bg-black text-white flex justify-center items-center font-mono p-4">
        <div className="w-full max-w-lg">
          <div className="mb-10 text-center">
            <h1 className="text-3xl font-black uppercase tracking-tighter mb-2 italic">Select <span className="text-orange-500">Edition</span></h1>
            <p className="text-gray-400 text-[10px] tracking-[0.3em] uppercase">Multiple Registrations Detected</p>
          </div>
            ...
            {multipleTeams.map((team) => (
              ...
              >
                <div className="relative z-10">
                  <div className="text-[10px] text-orange-500 font-black tracking-widest uppercase mb-1">{team.trackDisplay.split(':')[0]}</div>
                  <div className="text-xl font-bold uppercase tracking-tight group-hover:text-orange-400 transition-colors uppercase">{team.name}</div>
                  <div className="text-[9px] text-gray-500 mt-2 uppercase tracking-wide">Click to update submission</div>
                </div>

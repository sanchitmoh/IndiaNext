                ...
                <div className="flex flex-col gap-1">
                  {FAQ_NAV_LINKS.map((link, i) => (
                    ...
                    >
                      ...
                      >
                        <span className="w-6 text-[10px] font-mono font-black text-gray-700 group-hover:text-purple-500 transition-colors">
                        ...
                        <ChevronRight
                          size={14}
                          className="ml-auto text-gray-800 group-hover:text-purple-500 transition-colors"
                        />
                      </Link>
                    </motion.div>
                  ))}
...
const FAQHero = () => (
  <section className="relative z-10 min-h-[60vh] flex flex-col items-center justify-center pt-28 pb-16 px-4">
    ...
    >
      ...
      <motion.div
        variants={fadeInUp}
        className="inline-flex items-center gap-3 px-5 py-2 border border-purple-500/20 bg-purple-500/5 rounded-full mb-10 backdrop-blur-sm"
      >
      ...
      <motion.h1
        variants={fadeInUp}
        className="text-6xl md:text-[10rem] font-black leading-[0.8] tracking-tighter uppercase italic mb-6"
      >
      ...
      <motion.p
        variants={fadeInUp}
        className="text-gray-500 text-lg md:text-xl font-bold tracking-tight max-w-2xl mx-auto mb-4"
      >
      ...
      <motion.p
        variants={fadeInUp}
        className="text-gray-600 text-sm font-mono tracking-wider"
      ></motion.p>
    </motion.div>
  </section>
);
  ...
  const faqs: { question: string; answer: React.ReactNode }[] = [
    {
      ...
      answer: (
        <p>
          ...
          <strong className="text-white">students (undergraduate, postgraduate, diploma)</strong>{' '}
          from any recognized institution. Individual participants and teams are welcome.
        </p>
      ),
    },
    {
      ...
      answer: (
        <p>
          A team can have <strong className="text-white">1 to 4 members</strong>. Solo participation
          is allowed.
        </p>
      ),
    },
    {
      ...
      answer: (
        <div>
          <p className="mb-2">
            No. Each team can register for <strong className="text-white">only one track</strong>:
          </p>
    ...
    },
    {
      ...
      answer: (
        <p>
          Participation is <strong className="text-white">completely free</strong>. No registration
          fee is required.
        </p>
      ),
    },
        ...
        <div>
          ...
          <div className="flex flex-wrap gap-2 mt-2">
            {[
              ...
              <span
                key={d}
                className="px-3 py-1 text-[10px] font-mono font-black tracking-wider uppercase border border-white/10 bg-white/5 rounded-sm text-gray-400"
              >
                {d}
              </span>
            ))}
          ...
          <p className="mt-3 text-gray-500 text-xs italic">
            We are technology-agnostic — innovation matters more than the tech stack.
          </p>
        </div>
      ),
    },
      ...
      answer: (
        <p>
          ...
          <strong className="text-white">
            core logic and implementation must be done during the hackathon
          </strong>{' '}
          (for BuildStorm).
        </p>
      ),
    },
    {
      ...
      answer: (
        <div>
          <p className="mb-2">
            Yes, AI tools are allowed for code suggestions, debugging, research, and documentation.
          </p>
          <p className="text-amber-400 text-xs">
            ⚠️ Participants must understand and explain their implementation. Blind copy-pasting is
            strictly prohibited.
          </p>
        </div>
      ),
    },
    {
      ...
      answer: (
        <p>
          ...
          <strong className="text-white">event day</strong> or through official communication
          channels.
        </p>
      ),
    },
      ...
      answer: (
        <ul className="list-none space-y-2">
          <li className="flex items-center gap-2">
            <FileText size={14} className="text-green-400" /> Idea Deck (Max 10 slides)
          </li>
          <li className="flex items-center gap-2">
            <Video size={14} className="text-green-400" /> 3-minute Pitch Video
          </li>
          <li className="flex items-center gap-2">
            <Layout size={14} className="text-green-400" /> MVP Architecture / Mockup / wireframes
          </li>
          <li className="flex items-center gap-2">
            <Code size={14} className="text-green-400" /> GitHub Repository (Initialized at T-00:00)
          </li>
        </ul>
      ),
    },
    {
      ...
      answer: (
        <ul className="list-none space-y-2">
          <li className="flex items-center gap-2">
            <Code size={14} className="text-orange-400" /> Functional MVP (Built from scratch)
          </li>
          <li className="flex items-center gap-2">
            <Video size={14} className="text-orange-400" /> 3-minute Tech Walkthrough Video
          </li>
          <li className="flex items-center gap-2">
            <Code size={14} className="text-orange-400" /> GitHub Repository (Public)
          </li>
          <li className="flex items-center gap-2">
            <CheckCircle2 size={14} className="text-orange-400" /> Fully &apos;Run-Ready&apos;
            Project for Jury
          </li>
        </ul>
      ),
    },
    {
      ...
      answer: (
        <p>
          A <strong className="text-white">working demo is mandatory</strong> for evaluation.
          Incomplete or non-functional projects may be disqualified.
        </p>
      ),
    },
    {
      ...
      answer: (
        <div className="flex flex-wrap gap-2">
          {[
            ...
            <span
              key={c}
              className="px-3 py-1.5 text-[10px] font-mono font-black tracking-wider uppercase border border-cyan-500/20 bg-cyan-500/5 rounded-sm text-cyan-400"
            >
              {c}
            </span>
          ))}
    ...
    },
    {
      ...
      answer: (
        <p>
          <strong className="text-white">Participants retain ownership</strong> of their project.
          However, organizers may use project names, screenshots, or demo clips for promotional
          purposes.
        </p>
      ),
    },
    {
      ...
      answer: (
        <div>
          <p>
            Yes. All eligible participants will receive{' '}
            <strong className="text-white">Participation Certificates</strong>.
          </p>
          <p className="mt-1">
            Winners will receive{' '}
            <strong className="text-orange-400">Winner / Runner-Up Certificates</strong>.
          </p>
        </div>
      ),
    },
      ...
      answer: (
        <div>
          ...
          <ul className="list-none space-y-1">
            <li className="flex items-center gap-2">
              <Mail size={14} className="text-cyan-400" /> Registered Email
            </li>
            <li className="flex items-center gap-2">
              <Globe size={14} className="text-cyan-400" />
              <a
                href="https://www.indianexthackthon.online"
            ...
            <li className="flex items-center gap-2">
              <Users size={14} className="text-cyan-400" /> Official social media channels
            </li>
          </ul>
        </div>
      ),
      ...
      answer: (
        <p>
          ...
          <a
            ...
            className="text-orange-400 hover:text-white transition-colors underline decoration-orange-400/30"
          >
    ...
    },
    {
      ...
      answer: (
        <p>
          Yes. <strong className="text-white">All years are welcome</strong> — from first year to
          final year.
        </p>
      ),
    },
    {
      ...
      answer: (
        <p>
          Yes. <strong className="text-white">Cross-college teams are allowed</strong> and
          encouraged.
        </p>
      ),
    },
    {
      ...
      answer: (
        <p>
          You can modify your team <strong className="text-white">once</strong> through the
          dashboard after your initial registration. Changes are logged and once updated, the form
          will be <strong className="text-amber-400">locked</strong>. For any critical errors after
          locking, contact support.
        </p>
      ),
    },
  ];
    ...
    <div className="max-w-7xl mx-auto px-6">
      ...
      <div className="grid md:grid-cols-4 gap-16 items-start mb-24 text-left border-t border-white/5 pt-24">
        <div className="col-span-1 md:col-span-2">
          ...
          <h4 className="font-black text-4xl mb-8 uppercase tracking-tighter italic">
            K.E.S. Shroff College
          </h4>
        ...
        <div>
          <h4 className="text-gray-700 font-mono text-[10px] uppercase tracking-[0.5em] mb-12 font-black">
            DIRECTORIES
          </h4>
          <div className="flex flex-col gap-6 text-[10px] font-black tracking-widest uppercase">
            <Link href="/" className="text-gray-500 hover:text-orange-500 transition-colors italic">
              ./MISSION_HUB
            </Link>
            <Link
              href="/rules"
              className="text-gray-500 hover:text-orange-500 transition-colors italic"
            >
              ./RULEBOOK_v1.0
            </Link>
            <Link
        ...
        <div>
          ...
          <div className="flex flex-col gap-5 text-xs font-black">
            ...
            <p className="text-gray-600 mt-4 text-[10px] border border-white/5 py-2 px-4 inline-block">
              @KES_SHROFF_COLLEGE
            </p>
          </div>
        </div>
      ...
      <div className="pt-16 border-t border-white/5 flex flex-col md:flex-row justify-between items-center gap-10">
        ...
        <p className="text-gray-800 text-[8px] font-mono tracking-[0.8em] font-black uppercase text-center">

    ...
    it('should handle realistic audit log with all fields populated', () => {
      const logs = [
        createTestLog({
          ...
          fieldName: 'problemStatement',
          oldValue:
            'Our team wants to solve the problem of inefficient task management in small teams.',
          newValue:
            'Our team wants to solve the problem of inefficient task management in small teams. We will build a web application that helps teams collaborate better.',
          user: {
            id: 'user-123',
            name: 'Alice Johnson',
